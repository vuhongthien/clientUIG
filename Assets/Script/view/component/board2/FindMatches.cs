...
{
    public static FindMatches Instance { get; private set; }
                    ...
                    if (i > 0 && i < board.width - 1)
                    {
                        ...
                        if (leftdot != null && rightdot != null)
                        {
                            if (leftdot.tag == currentDot.tag && rightdot.tag == currentDot.tag)
                            {
                                ...
                                leftdot.GetComponent<Dot>().isMathched = true;
                                if (!currentMatches.Contains(rightdot))
                                {
                                    currentMatches.Add(rightdot);
                                }
                                rightdot.GetComponent<Dot>().isMathched = true;
                                if (!currentMatches.Contains(currentDot))
                                {
                                    currentMatches.Add(currentDot);
                                }
                                currentDot.GetComponent<Dot>().isMathched = true;
                            }
                        }
                    }
                    ...
                    if (j > 0 && j < board.height - 1)
                    {
                        ...
                        if (updot != null && downdot != null)
                        {
                            if (updot.tag == currentDot.tag && downdot.tag == currentDot.tag)
                            {
                                ...
                                updot.GetComponent<Dot>().isMathched = true;
                                if (!currentMatches.Contains(downdot))
                                {
                                    currentMatches.Add(downdot);
                                }
                                downdot.GetComponent<Dot>().isMathched = true;
                                if (!currentMatches.Contains(currentDot))
                                {
                                    currentMatches.Add(currentDot);
                                }
