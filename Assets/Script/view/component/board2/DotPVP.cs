...
/// </summary>
public class DotPVP : MonoBehaviourPun
{
    [Header("Game Mode")]
    ...
    private static DotPVP firstSelectedDot = null;
    ...
    void SwapPieces(DotPVP otherDot)
    {
    ...
    void MovePiecesSinglePlayer()
    {
        ...
        if (swipeAngle > -45 && swipeAngle <= 45 && column < board.width - 1)
        {
            ...
            previousRow = row;
            otherDot.GetComponent<DotPVP>().column -= 1;
            column += 1;
        }
        else if (swipeAngle > 45 && swipeAngle <= 135 && row < board.height - 1)
        {
            ...
            previousColumn = column;
            previousRow = row;
            otherDot.GetComponent<DotPVP>().row -= 1;
            row += 1;
        }
        else if ((swipeAngle > 135 || swipeAngle <= -135) && column > 0)
        {
    ...
    public IEnumerator CheckMoveCo()
    {
        ...
        if (otherDot != null)
        {
            DotPVP otherDotComponent = otherDot.GetComponent<DotPVP>();
